...
SUBROUTINE initialisation(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc,rhs_vbc, &
    ...
    CALL Euler(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc_i,rhs_vbc_i, & 
         rhs_eta_i,rhs_psi_i,rhs_uxi_i, rhs_vxi_i,Q,Qbt,f,pr2c,pc2r,k2,datc)


    CALL AB2(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc_i,rhs_vbc_i, &
         rhs_eta_i, rhs_psi_i,rhs_uxi_i, rhs_vxi_i,Q,Qbt,f,pr2c,pc2r,k2,datc)
    ...
    DO t = 3, N_init
       ...
       CALL AB3_i(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc_i,rhs_vbc_i, &
            rhs_eta_i, rhs_psi_i,rhs_uxi_i, rhs_vxi_i,Q,Qbt,f,pr2c,pc2r,k2,datc)
