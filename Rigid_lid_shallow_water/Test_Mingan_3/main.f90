...
!                         Main program - Shallow water 
  ...
  PROGRAM main
    ...
    INCLUDE 'write_fields.f90'
     ...
     CALL initialisation(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc,rhs_vbc,rhs_eta,& 
     ...
     DO t = 3,Nt
        ...
        CALL AB3(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc,rhs_vbc,rhs_eta,rhs_psi,& 
       rhs_uxi, rhs_vxi, f, pr2c, pc2r, k2, datc)
