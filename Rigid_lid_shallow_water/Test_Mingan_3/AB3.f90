  ...
  SUBROUTINE AB3(ubc,vbc,eta,psi,eta_b,uxi,vxi,ener,rhs_ubc,rhs_vbc,rhs_eta,rhs_psi,& 
    ...
    ! Calcul des variables dépendantes de psi,eta,ubc,vbc
     ...
     CALL calc_variables_dependantes(ubc,vbc,eta,psi,eta_b(Nx+1,Ny+1),uxi,vxi,ener,u,v,ubt,vbt,& 
       hleft,hdown)
